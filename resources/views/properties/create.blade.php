...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
    ...
    <form action="{{ route('properties.store') }}" method="POST" class="max-w-2xl">
        @csrf
        ...
        <div class="mb-6">
            ...
            <input type="number" id="price" name="price" value="{{ old('price') }}" required min="0" step="0.01" class="w-full px-4 py-2 border  dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-white @error('price') border-red-500 @enderror">
        ...
        <div class="mb-6">
            ...
            <input type="number" id="area" name="area" value="{{ old('area') }}" required min="0" class="w-full px-4 py-2 border  dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-white @error('area') border-red-500 @enderror">
